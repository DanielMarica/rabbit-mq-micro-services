...
/**
 * OrderServiceApplication - Classe principale du Order Service
 * 
 * Cette classe démarre l'application Spring Boot du Order Service.
 * 
...
public class OrderServiceApplication {
     ...
     * 5. Démarre l'application sur le port configuré (8083)
     * 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("================================================");
        System.out.println("🚀 Order Service démarré avec succès !");
        System.out.println("📍 Port : 8083");
        System.out.println("🗄️  Base de données : H2 (en mémoire)");
        System.out.println("🌐 Console H2 : http://localhost:8083/h2-console");
        System.out.println("📡 API : http://localhost:8083/orders");
        System.out.println("================================================");
    }
}
